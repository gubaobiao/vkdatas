...
<body>
    ...
    <div class="mywrap2">
        <div class="enws_img">
            <video width="100%" height="100%" src="<?php echo ($video["mp4"]); ?>" controls poster="<?php echo ($video["sltpath"]); ?>"></video>
            <!-- <img src="<?php echo (C("asset_wap")); ?>/img/news.jpg" width="100%" /> -->
        </div>
        <div class="content">
            <div class="content_text">
                <p class="p1"><?php echo ($video["title"]); ?></p>
                <p class="time"><?php echo ($video["pubday"]); ?></p>
            </div>
            <div class="p3"><?php echo ($video["content"]); ?></div>
        </div>
        ...
        <div class="cover">
            <div class="shareArea">
                <div class="shareblock_one">
                    ...
                    <p class="share_t2"><?php echo ($video["title"]); ?></p>
                </div>
        ...
        <!--相关推荐-->
        <div class="recommend">
            <div class="recommend_t">相关推荐</div>

            <?php if(is_array($video_all)): foreach($video_all as $key=>$vo): ?><a class="recommend_b" href="<?php echo ($domain); ?>/anli/<?php echo ($vo['id']); ?>.html">
                    <div class="r_img">
                        <img src="<?php echo ($vo["sltpath"]); ?>" width="100%"/>
                    </div>
                    <div class="r_info">
                        <p class="r_title1"><?php echo ($vo["title"]); ?></p>
                        <p class="r_title2">#<?php echo ($vo["typeTitle"]); ?>#</p>
    ...
    <script>
        window._bd_share_config={
            "common":{
                bdText : "<?php echo ($video["title"]); ?>",
                bdDesc : "<?php echo ($video["description"]); ?>",
                bdUrl : "<?php echo ($domain); ?>/anli/<?php echo ($video['id']); ?>.html",
                bdPic : "<?php echo ($video["sltpath"]); ?>"
            },
            "share":{},
            "image":{
