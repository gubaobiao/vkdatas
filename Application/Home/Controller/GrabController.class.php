 ...
 */
/*function main() {
    $file_path = "url-0121.txt";
    $current_url = "http://www.donghuajie.com"; //初始url
    ...
    public function index(){
        ...
        $site = new \Org\Util\ Sitemap();
        //var_dump($site);
        $cate = M('news')->select();
        //var_dump($cate);die();
            foreach ($cate as $v)
            {//$v['title']
              $site->AddItem($url.'/news/'.$v['id'].'/html', 1);
            }
       // var_dump($site);die();
        $site->SaveToFile('sitemap.txt');
  ...
  public function index2(){
        ...
        //var_dump($cate);die();
            foreach ($cate as $v)
            {//$v['title']
              $site->AddItem($url.'/anli/'.$v['id'].'/html', 1);
            }
       // var_dump($site);die();
        $site->SaveToFile('sitemap2.txt');
